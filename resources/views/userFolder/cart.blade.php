    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right font-weight-semibold align-middle p-4">Rs.{{ $cart_item->books->price }}</td> <!-- Assuming you have a price column -->
                    <td class="align-middle p-4">
                        <input type="text" class="form-control text-center" onchange="window.location.href='change-quantity-{{ $cart_item->id }}-' + this.value" value="{{ $cart_item->quantity }}">
                    </td>
                    <?php
                            $total=$total+$cart_item->books->price * $cart_item->quantity;
                            ?>
                    <td class="text-right font-weight-semibold align-middle p-4">Rs.{{ $cart_item->books->price * $cart_item->quantity }}</td> <!-- Total price -->
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
            ...
            <div class="d-flex">
                ...
                <div class="text-right mt-4">
                    ...
                    <div class="text-large"><strong>Rs. {{ $total }}</strong></div>
                </div>
            </div>
        </div>
        ...
        <div class="float-right">
            <a href="/#popular-books">
                <button type="button" class="btn btn-lg btn-default btn-dark md-btn-flat mt-2 mr-3">Back to shopping</button>
            </a>
        ...
        <a href="/#popular-books">
            <button type="button" class="btn btn-lg btn-dark btn-default md-btn-flat mt-2 mr-3">Back to shopping</button></a>
