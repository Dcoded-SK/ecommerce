                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <figure class="products-thumb">
                            <img src="{{ asset('books_picture/'.$mostOrderedBook->picture) }}" width="600px" height="500px" alt="book" class="single-image">
                        </figure>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="product-entry">
                            ...
                            <div class="products-content">
                                <div class="author-name">By {{ $mostOrderedBook->author }}</div>
                                <h3 class="item-title">{{ $mostOrderedBook->title }}</h3>
                                <p>{{$mostOrderedBook->genre->name}}</p>
                                <div class="item-price">Rs. {{ $mostOrderedBook->price }} /- only</div>
                                <div class="btn-wrap">
                                    <a href="/add-to-cart-{{ $mostOrderedBook->id }}" class="btn-accent-arrow">shop it now <i class="icon icon-ns-arrow-right"></i></a>
                                </div>
                            </div>
